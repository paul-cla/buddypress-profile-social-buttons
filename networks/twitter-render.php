...
/* only include the  extension if enabled */
  ...
  if ( $psb_extension_check == '1' ) {
	function show_twitter_icon() {
		...
		?>
		<a class="bp-profile" href="<?php echo $twitter_address; ?>" target="_blank"><img src="<?php bloginfo('wpurl'); ?>/wp-content/plugins/buddypress-profile-social-buttons/img/twitter.png" /></a>
		<?php
		}
	}
