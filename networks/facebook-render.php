...
/* only include the  extension if enabled */
  ...
  if ( $psb_extension_check == '1' ) {
	function show_facebook_icon() {
		...
		?>
		<a class="bp-profile" href="<?php echo $facebook_address; ?>" target="_blank" ><img src="<?php bloginfo('wpurl'); ?>/wp-content/plugins/buddypress-profile-social-buttons/img/facebook.png" /></a>
		<?php
		}
	}
