...
/* only include the  extension if enabled */
  ...
  if ( $psb_extension_check == '1' ) {
	function show_facebook_icon() {
		...
		?>
		<a class="bp-fb-profile" href="<?php echo $facebook_address; ?>" ><img src="<?php bloginfo('wpurl'); ?>/wp-content/plugins/buddypress-profile-social-buttons/img/facebook_social.gif" /></a>
		<?php
		}
	}
